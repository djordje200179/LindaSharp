...
class HealthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetScriptExecutionStatus = channel.unary_unary(
                '/Health/GetScriptExecutionStatus',
                request_serializer=google_dot_protobuf_dot_wrappers__pb2.Int32Value.SerializeToString,
                response_deserializer=health__pb2.ScriptExecutionStatus.FromString,
                _registered_method=True)
...
def add_HealthServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetScriptExecutionStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=health__pb2.ScriptExecutionStatus.SerializeToString,
            ),
    }
...
class Health(object):
    ...
    def GetScriptExecutionStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            health__pb2.ScriptExecutionStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
